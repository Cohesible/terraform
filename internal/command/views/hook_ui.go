...
func (h *UiHook) PostApply(addr addrs.AbsResourceInstance, gen states.Generation, newState cty.Value, applyerr error, src *states.ResourceInstanceObjectSrc) (terraform.HookAction, error) {
	id := addr.String()
