...
func (h *countHook) PostApply(addr addrs.AbsResourceInstance, gen states.Generation, newState cty.Value, err error, src *states.ResourceInstanceObjectSrc) (terraform.HookAction, error) {
	h.Lock()
	defer h.Unlock()
