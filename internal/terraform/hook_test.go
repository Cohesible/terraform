...
func (h *testHook) PostApply(addr addrs.AbsResourceInstance, gen states.Generation, newState cty.Value, err error, src *states.ResourceInstanceObjectSrc) (HookAction, error) {
	h.mu.Lock()
	defer h.mu.Unlock()
